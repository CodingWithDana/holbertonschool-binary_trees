...
/**
 * recursively_check_perfect_subtree - helper function to recursively check if every subtree is perfect
 ...
 */
static int recursively_check_perfect_subtree(const binary_tree_t *tree, int depth, int level)
{
